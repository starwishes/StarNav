...
export const readImageDimensions = (buffer: Buffer, ext: ImageExt) => {
  switch (ext) {
    case 'png':
...
/**
 * Parse a data-URI image upload: type sniff + dimension limits + size cap.
 */
export const parseImageData = (data: string | undefined | null, allowedExts: string[]) => {
