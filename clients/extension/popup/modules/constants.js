...
export const i18n = {
  zh: {
    ...
    reconnectTip: '请重新输入密码以重新连接。用户名已预填。',
    reconnect: '重新连接',
    reconnecting: '重新连接中…',
    reconnectFailed: '重新连接失败',
    reconnected: '已重新连接',
    reconnectMissingCredentials: '请输入用户名和密码',
    edit: '编辑',
    delete: '删除',
  ...
  en: {
    ...
    reconnectTip: 'Re-enter your password to reconnect. Your username is filled in.',
    reconnect: 'Reconnect',
    reconnecting: 'Reconnecting…',
    reconnectFailed: 'Reconnect failed',
    reconnected: 'Reconnected',
    reconnectMissingCredentials: 'Please enter username and password',
    edit: 'Edit',
    delete: 'Delete',
